...
//	private ResourceBundle resources;
	...
	public void initialize() {
		...
		//pane1.setStyle("-fx-background-image: url('application/thumb-1920-418656.jpg')");
		//pane2.setStyle("-fx-background-image: url('application/thumb-1920-521718.jpg')");
		//pane3.setStyle("-fx-background-image: url('application/thumb-1920-786565.jpg')");
		//pane4.setStyle("-fx-background-image: url('application/thumb-1920-90498.jpg')");
