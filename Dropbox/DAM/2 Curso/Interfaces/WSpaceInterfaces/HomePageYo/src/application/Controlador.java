...
//        fadeTransition.play();
        ...
        //pane1.setStyle("-fx-background-image: url('application/carrot.jpg')");
        //pane2.setStyle("-fx-background-image: url('application/GoblinSlayer.jpg')");
        //pane3.setStyle("-fx-background-image: url('application/thumb-1920-608887.jpg')");
        //pane4.setStyle("-fx-background-image: url('application/thumb-1920-964702.jpg')");
